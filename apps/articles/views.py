...
class ArticleListView(ListView):
    ...
    def get_queryset(self) -> QuerySet[Any]:
        return Article.objects.filter(public=True).order_by('-date_added', '-ranking', '-views')
...
class ArticleDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['related'] = self.object.related.filter(public=True).order_by('-ranking', '-views', '-date_added')
        return context
